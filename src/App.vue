<template>
  <div class="viewport-wrapper">
    <div class="app-container">
      ...
      <Scene4 v-else-if="currentView === 'scene4'" @changeScene="changeScene" />
      <Scene5 v-else-if="currentView === 'scene5'" @changeScene="changeScene" />
...
import Scene4 from './scene/scene4.vue'
import Scene5 from './scene/scene5.vue'
