...
const backgroundStyle = computed(() => {
  ...
  } else if (props.scene === 'scene4') {
    imagePath = new URL('@/assets/background/bg5.png', import.meta.url).href
  } else if (props.scene === 'scene5') {
    imagePath = new URL('@/assets/background/bg6.png', import.meta.url).href
  }
