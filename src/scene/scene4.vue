<template>
  <div class="scene4">
    ...
    <Background scene="scene4" />

    <!-- 故事生成 -->
    <StoryProvider
      background="喜多川百音子，年幼时的你，日本经济蓬勃发展，你正漫步在热闹的集市街头。
      街道两旁店铺林立，有卖寿司的、有卖团子的，还有卖各种小饰品的。街道上人来人往，有穿着和服的行人，
      也有穿着现代服装的人。街边还有一些艺人在表演，有弹三味线的，有跳传统舞蹈的"
      ending="走累了，你感觉有些无聊，想找些有趣的事做"
      scene="集市街头"
      @ready="onStoryReady"
    />
